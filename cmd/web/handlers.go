...
func (app *Config) SubscribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	// generate an invoice and send an email with the invoice attached
	app.Wait.Add(1)
	...
	go func() {
		...
		app.sendEmail(msg) // Here we are adding 1 to the WG too!!

	}()

	// generate a manual and send an email with the manual attached
	app.Wait.Add(1)
	go func() {
		defer app.Wait.Done()
